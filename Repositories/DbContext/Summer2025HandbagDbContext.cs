...
public partial class Summer2025HandbagDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brand__DAD4F3BE33E09654");
        ...
        {
            entity.HasKey(e => e.HandbagId).HasName("PK__Handbag__785BD69FF3D8930C");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA58674FFF6D7");
